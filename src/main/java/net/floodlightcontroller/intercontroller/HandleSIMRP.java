...
public class HandleSIMRP {
	...
	public static byte handleUpdataNIB(byte[] msg, OutputStream out, boolean HelloFlag) throws IOException{
		if(!HelloFlag){
		...
		//	printNIB(InterSocket.NIB);		//for test
		}		
	...
	public static byte handleUpdateRIB(byte[] msg, OutputStream out, boolean HelloFlag) throws JsonGenerationException, JsonMappingException, IOException{
		if(!HelloFlag){
	...
	public static byte handleMsg(byte[] msg, OutputStream out, boolean HelloFlag) throws IOException{
